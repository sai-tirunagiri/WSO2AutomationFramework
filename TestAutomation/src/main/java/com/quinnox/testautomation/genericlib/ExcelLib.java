...
public class ExcelLib {
	...
	String filePath = "C:\\Users\\narayan\\Desktop\\test_data.xlsx";
	String filePathToPost = "C:\\Users\\narayan\\Documents\\test_data_post.xlsx";
	...
	public String getExcelDataForPost(String sheetName , int rowNum, int colNun) throws InvalidFormatException, IOException{
		FileInputStream fis = new FileInputStream(filePathToPost);
		Workbook wb = WorkbookFactory.create(fis);
		Sheet sh = wb.getSheet(sheetName);
		Row row = sh.getRow(rowNum);
		Cell cel = row.getCell(colNun);
